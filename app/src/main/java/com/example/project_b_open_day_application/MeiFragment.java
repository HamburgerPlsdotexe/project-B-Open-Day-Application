...
public class MeiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragmei, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                shareintent.putExtra(Intent.EXTRA_TEXT, getContext().getString(R.string.share_message_may));
        ...
        fad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                beginTime.set(2019, 4, 14, 10, 00);
                Calendar endTime = Calendar.getInstance();
                endTime.set(2019, 4, 14, 14, 00);
